  ...
  render () {
    return <article className='ly-content ly-section'>
      ...
      <section className='hm-section'>
        ...
        <p>I like writing about the current <a href='http://ponyfoo.com/articles/stop-breaking-the-web' title='Stop Breaking the Web' target='_blank'>state of the web</a>, new features coming our way in <a href='http://ponyfoo.com/articles/universal-react-babel' title='Universal React with Babel, Browserify'>ES6</a>, leveraging <a href='http://ponyfoo.com/articles/talk-about-web-performance' title="Let's talk about Web Performance" target='_blank'>web performance</a> optimization to make our sites much faster, the importance of <a href='http://ponyfoo.com/articles/progressive-web' title='The Progressive Web' target='_blank'>progressive enhancement</a>, sane <a href='http://ponyfoo.com/articles/gulp-grunt-whatever' title='Gulp, Grunt, Whatever' target='_blank'>build processes</a> and improving quality in your applications with <a href='http://ponyfoo.com/articles/why-i-write-plain-javascript-modules' title='Why I Write Plain JavaScript Modules' target='_blank'>modular design</a>. I used to spend a lot of my time on <a href='/stackoverflow' target='_blank'>Stack Overflow</a>, but now I spend most that time doing open-source work instead.</p>
        ...
        <section className='hm-section hm-photo-section'>
          <a href='http://ponyfoo.com' title='Pony Foo' target='_blank'><img className='hm-photo' src='/img/me.jpg' alt='Pony Foo' /></a>
